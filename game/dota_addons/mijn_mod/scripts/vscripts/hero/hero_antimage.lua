...
function ManaBreak( keys )
	...
	--let antimage gain equal amount of mana
	local current_mana = caster:GetMana()
	caster:SetMana(current_mana + mana_to_burn)
